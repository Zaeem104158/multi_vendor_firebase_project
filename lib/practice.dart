...
//       child: Scaffold(
//         appBar: AppBar(
//           title: Text('Category Form Example'),
//         ),
//         body: Padding(
...
//                     value: provider.selectedMainCategory,
//                     onChanged: (value) {
//                       provider.setMainCategory(value!);
//                     },
//                     items: [
//                       DropdownMenuItem(
//                         value: 'Category 1',
...
//                   TextFormField(
//                     onChanged: (value) {
//                       provider.setTextFieldValue(value);
//                     },
...
//                   ),
//                   SizedBox(height: 16.0),
//                   if (provider.isSubmitButtonVisible)
//                     ElevatedButton(
//                       onPressed: () {
